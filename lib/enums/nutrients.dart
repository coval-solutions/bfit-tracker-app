...
extension NutrientsEnumExtension on NutritionEnum {
  String get name {
  ...
  String get units {
    switch (this) {
      case NutritionEnum.CALCIUM:
      case NutritionEnum.IRON:
      case NutritionEnum.POTASSIUM:
      case NutritionEnum.SODIUM:
      case NutritionEnum.CHOLESTEROL:
        return 'mg';
        break;
      case NutritionEnum.VITAMIN_A:
        return 'mcg';
        break;
      default:
        return 'g';
  ...
  String get description {
    switch (this) {
      case NutritionEnum.CARBOHYDRATES:
  ...
  static Map<String, NutritionEnum> map() {
    return {
      'total_carbs': NutritionEnum.CARBOHYDRATES,
      'total_fat': NutritionEnum.FAT,
      'fiber': NutritionEnum.FIBRE,
      'calcium': NutritionEnum.CALCIUM,
      'potassium': NutritionEnum.POTASSIUM,
      'vitamin_a': NutritionEnum.VITAMIN_A,
      'vitamin_c': NutritionEnum.VITAMIN_C,
      'sodium': NutritionEnum.SODIUM,
      'protein': NutritionEnum.PROTEIN,
      'iron': NutritionEnum.IRON,
      'cholesterol': NutritionEnum.CHOLESTEROL,
      'sugar': NutritionEnum.SUGAR,
    };
  }
}
